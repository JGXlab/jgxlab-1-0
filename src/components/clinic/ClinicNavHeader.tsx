  ...
  return (
    <div className="sticky top-0 w-full bg-white rounded-t-2xl px-6 py-3 flex items-center justify-between z-10">
      ...
      <div className="flex items-center space-x-6">
        ...
        <nav className="flex items-center space-x-3 border border-gray-200 rounded-full px-1.5 py-2 h-10">
          <button 
            onClick={() => navigate("/clinic/dashboard")}
            className={`flex items-center space-x-1.5 px-3 h-full rounded-full transition-all duration-200 ${
